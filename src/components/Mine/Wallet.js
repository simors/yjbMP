...
import {payDeposit} from '../../actions/authActions'
      ...
      <Page ptr={false}>
        ...
        <div className="deposit">
          ...
          <div className="depositButton-area">
            <Button type='primary' plain className="depositButton" onClick={this.onDeposit}>{this.props.currentUser.deposit === 0? '交押金' : '退押金'}</Button>
          </div>
        </div>
      </Page>
    )
