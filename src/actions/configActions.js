...
export const updateInitUrl = createAction(configActionTypes.UPDATE_INIT_URL)
export const updateInitUrlSuccess = createAction(configActionTypes.UPDATE_INIT_URL_SUCCESS)